...
nargs=len(sys.argv)
if nargs!=3:
  print('usage: '+os.path.basename(__file__)+' <configuration file> <ntop>')
  print('ntop: number of top weights to use. default is 200.')
  sys.exit()
#end if
ntop=int(sys.argv[2])
if ntop<=0: ntop=200
...
#excluding self loop
#ntop=200#select edges with top abs weights
print('extracting ntop %d'%ntop)
nsel=0
ret_i=0
ll=list()
